...
My current stage in the Engineering Design Process (EDP) is building my project. A little recap of what my project is: a game that uses A-Frame. My partner and I aim to create a stress-relieving shooting game. We plan on making a 3D simulation of our game with stages featuring unique backgrounds. To learn my tool, I had to understand how A-Frame works and the components A-Frame uses. To get a better understanding of my tool (A-Frame), I read documentations made by the developer. Now, my partner and I use jsbin to coding and test new things and when we like the code, we add it to our IDE.

 Every weekend my partner and I call each other and share our screen every times we code to show each other what we are doing. Calling each other makes us accountable to do the work. Each week we alternate on who leads. On week one, shelly took the lead on selecting a background that will be best for our game and I listed the pro and cons of each setting. Shelly also started on making a model of a building. On week two, I took the lead on makes a design for the building and make the road in our game.
...
Currently I think we are focusing on making a founation for our games throught HTMl and starting next week, we will start coding for js more.

I have learned a lot of things while learn and coding using Aframe.

My thought process and accompishments made so far:
...
- decided the setting for our game level 1: Default
 ...
 we decided that defalt would be best to add our own buildings on.
...
* Time management: Since I can't work only on the project, I'm trying split up my work thoughout the day. On Mondays, I try to find new findings or tutorials to work on, and whenever I have the time, I work on them. On saturadays, my partner and I call to work and make progress on our project. On Sundays, I reflect on what I learned and take note of the useful things I learned.
...
* Learn geometry componet to learn help make cars
* Also we want to work on learning animation for makeing moving tress and a moving car.
Over the course of 2 weeks my partner and I want to learn the componenets:
* Person (POV)- controls the camera/veiwpoint
